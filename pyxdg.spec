...
%prep
%setup -q -n pyxdg-0.27
cd %{_builddir}/pyxdg-0.27
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625014767
...
cp %{_builddir}/pyxdg-0.27/COPYING %{buildroot}/usr/share/package-licenses/pyxdg/44f7289042b71631acac29b2f143330d2da2479e
